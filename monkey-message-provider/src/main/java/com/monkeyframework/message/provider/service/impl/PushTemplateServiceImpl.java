...
import com.monkeyframework.message.provider.dao.PushTemplateMapper;
import com.monkeyframework.message.provider.dao.extend.PushTemplateExtendMapper;
...
public class PushTemplateServiceImpl implements PushTemplateService {
	 ...
	 * @return
	 */
	public void update(Long id, PushTemplate temp) throws monkeyException {
