package com.monkeyframework.message.provider.plus.mail;
...
import com.monkeyframework.message.provider.plus.mail.bean.MailAuthenticator;
import com.monkeyframework.config.core.util.StringUtils;
