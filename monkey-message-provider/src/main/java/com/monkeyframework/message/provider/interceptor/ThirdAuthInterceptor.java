...
public class ThirdAuthInterceptor {
	...
	@AfterReturning(value="execution(* com.monkeyframework.message.provider.service.impl.ThirdAuthServiceImpl.save(..))", 
	...
	@AfterReturning(value="execution(* com.monkeyframework.message.provider.service.impl.ThirdAuthServiceImpl.delete(..))", 
			argNames="rtv", returning="rtv")
	...
	@AfterReturning(value="execution(* com.monkeyframework.message.provider.service.impl.ThirdAuthServiceImpl.update(..))", 
			argNames="rtv", returning="rtv")
